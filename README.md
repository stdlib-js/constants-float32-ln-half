...
```javascript
import FLOAT32_LN_HALF from 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float32-ln-half@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/constants-float32-ln-half/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/constants-float32-ln-half/actions/workflows/test.yml?query=branch:v0.1.0
